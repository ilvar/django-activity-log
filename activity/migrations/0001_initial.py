...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityContent'
        db.create_table('activity_activitycontent', (
        ...
        db.send_create_signal('activity', ['ActivityContent'])
    ...
    def backwards(self, orm):
        # Deleting model 'ActivityContent'
        db.delete_table('activity_activitycontent')
    ...
    models = {
        ...
        'activity.activitycontent': {
            'Meta': {'object_name': 'ActivityContent'},
